...
$http.get("https://www.googleapis.com/language/translate/v2?q="+encodeURIComponent($scope.input)+"&source="+$scope.source+"&target="+$scope.resultlang+"&key=AIzaSyAhPZ_-mcpgQAadbJf0noMNMINhc6Z0Tgw")
